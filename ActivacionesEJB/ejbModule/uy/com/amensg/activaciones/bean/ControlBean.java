...
import uy.com.amensg.activaciones.entities.Control;
import uy.com.amensg.activaciones.entities.Empresa;
import uy.com.amensg.activaciones.entities.EstadoControl;
import uy.com.amensg.activaciones.entities.MetadataCondicion;
...
import uy.com.amensg.activaciones.entities.MetadataOrdenacion;
import uy.com.amensg.activaciones.util.Configuration;
import uy.com.amensg.activaciones.util.Constants;
import uy.com.amensg.activaciones.util.QueryHelper;
...
//			queryCount.setParameter("usuario2", usuarioId);
	...
	public String procesarArchivoEmpresa(String fileName, Long empresaId, Long tipoControlId, Long loggedUsuarioId) {
		...
		try {
			...
			insertControl.setParameter(2, empresa.getId(), LongType.INSTANCE);
			insertControl.setParameter(3, estado.getId(), LongType.INSTANCE);
			insertControl.setParameter(4, hoy, DateType.INSTANCE);
			
			insertControl.setParameter(5, hoy, DateType.INSTANCE);
			insertControl.setParameter(6, new Long(1), LongType.INSTANCE);
			insertControl.setParameter(7, loggedUsuarioId, LongType.INSTANCE);
			
			insertControl.setParameter(8, new Long(0), LongType.INSTANCE);
			insertControl.setParameter(9, new Long(0), LongType.INSTANCE);
			insertControl.setParameter(10, fechaMin, DateType.INSTANCE);

...
<head>
	...
	<script type="text/javascript" src="/ActivacionesWEB/dwr/interface/EstadoControlDWR.js"></script>
	...
	<script type="text/javascript" src="/ActivacionesWEB/dwr/interface/TipoControlDWR.js"></script>
	<script type="text/javascript" src="/ActivacionesWEB/dwr/interface/ControlDWR.js"></script>
	...
	<script type="text/javascript" src="/ActivacionesWEB/pages/controles/controles.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="/ActivacionesWEB/pages/controles/controles.css"/>
</head>
<body>
		...
		<div id="divImportacionArchivo">
			...
			<div class="divMainWindow">
				<form id="formSubirArchivo" method="POST" action="/ActivacionesWEB/Upload" enctype="multipart/form-data">
					<input type="hidden" name="caller" value="/ActivacionesWEB/pages/controles/controles.jsp"/>
					<div class="divFormLabelExtended">Empresa:</div><div id="divEmpresa"><select id="selectEmpresa" name="selectEmpresa"></select></div>
					<div class="divFormLabelExtended">Tipo control:</div><div id="divTipoControl"><select id="selectTipoControl" name="selectTipoControl"></select></div>

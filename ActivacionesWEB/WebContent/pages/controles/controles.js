					...
					if (data.usuarioRolEmpresas[i].rol.id == __ROL_ADMINISTRADOR){
						...
						grid = new Grid(
							document.getElementById("divTableControles"),
							{
								...
								tdFechaControl: { campo: "fechaControl", abreviacion: "F. Control", descripcion: "Fecha de control", tipo: __TIPO_CAMPO_FECHA },
								...
								tdCargaInicial: { campo: "cargaInicial", descripcion: "Carga inicial", abreviacion: "Carga ini.", tipo: __TIPO_CAMPO_NUMERICO },
								tdMontoCargar: { campo: "montoCargar", descripcion: "Monto a cargar", abreviacion: "Monto cargar", tipo: __TIPO_CAMPO_NUMERICO },
								tdEstadoControl: { campo: "estadoControl.nombre", clave: "estadoControl.id", descripcion: "Estado", abreviacion: "Estado", tipo: __TIPO_CAMPO_RELACION, dataSource: { funcion: listEstadoControles, clave: "id", valor: "nombre" }, ancho: 80 },
								tdTipoControl: { campo: "tipoControl.descripcion", clave: "tipoControl.id", descripcion: "Tipo", abreviacion: "Tipo", tipo: __TIPO_CAMPO_RELACION, dataSource: { funcion: listTipoControles, clave: "id", valor: "descripcion" }, ancho: 80 }
							}, 
							reloadData,
							trControlOnClick
						);
...
function trControlOnClick(eventObject) {
	...
	document.getElementById("iFrameControl").src = "/ActivacionesWEB/pages/controles/control.jsp?m=" + formMode + "&aid=" + $(target).attr("id");
...
function inputAgregarMidOnClick(event, element) {
	document.getElementById("iFrameControl").src = "/ActivacionesWEB/pages/controles/controles.jsp?m=" + __FORM_MODE_NEW;
	showPopUp(document.getElementById("divIFrameControl"));
}

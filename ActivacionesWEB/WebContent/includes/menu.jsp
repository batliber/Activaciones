...
<%@ page import="uy.com.amensg.activaciones.dwr.UsuarioDWR"  %>
<%@ page import="uy.com.amensg.activaciones.entities.UsuarioTO"  %>
<%@ page import="uy.com.amensg.activaciones.entities.MenuTO"  %>

<%@ page import="javax.naming.Context" %>
<%@ page import="javax.naming.InitialContext" %>

<%@ page import="uy.com.amensg.activaciones.bean.ISeguridadBean"  %>
<%@ page import="uy.com.amensg.activaciones.bean.IUsuarioBean"  %>
<%@ page import="uy.com.amensg.activaciones.bean.SeguridadBean"  %>
<%@ page import="uy.com.amensg.activaciones.bean.UsuarioBean"  %>
<%@ page import="uy.com.amensg.activaciones.entities.Usuario"  %>
<%@ page import="uy.com.amensg.activaciones.entities.UsuarioTO"  %>
...
%>
	...
	<div class="inactiveMenuBarItem">
		<div id="divLogo"><img id="imgLogo" src="/ActivacionesWEB/images/logo-vos-bw.png"/></div>
	</div>
